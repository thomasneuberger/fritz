...
The deployment uses Azure's `bindingType: 'Auto'` feature (available in API version 2024-03-01 and later, using 2025-07-01) to solve the circular dependency problem:
